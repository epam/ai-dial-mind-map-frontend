...
const allProviders: (Provider | boolean)[] = [
  ...
  !!process.env.AUTH_AZURE_B2C_CLIENT_ID &&
    ...
    AzureB2CProvider({
      ...
      authorization: {
        params: {
          scope: process.env.AUTH_AZURE_B2C_SCOPE || 'openid profile user.Read email offline_access',
        },
      },
      token: tokenConfig,
    }),
  ...
  !!process.env.AUTH_KEYCLOAK_CLIENT_ID &&
    ...
    KeycloakProvider({
      ...
      authorization: {
        params: {
          scope: process.env.AUTH_KEYCLOAK_SCOPE || 'openid dial profile email offline_access',
        },
      },
      token: tokenConfig,
    }),
